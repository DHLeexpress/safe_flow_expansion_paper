...
and derive a lower bound on the probability that a generated batch contains a valid action at a fixed context and $\gamma$. We further show how the number of batches and $\gamma$ trade off safety and performance.
