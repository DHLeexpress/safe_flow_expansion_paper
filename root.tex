...
In out-of-distribution (OOD) contexts, safety guarantees will fail in a fixed pretrained policy~\cite{luo2024potential}. This limitation motivates our goal of offline OOD adaptation via continued pre-training of the CFM policy.
...
We further evaluate how $\gamma$ and deployment batch size trade off safety and performance.
