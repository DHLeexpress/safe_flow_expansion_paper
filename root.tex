...
\title{\LARGE \bf
Safe Flow Expansion: \\ Generative Model Self-Generating Safety-Critical Planning
}
...
\begin{figure}
    ...
    \vspace{-2.5mm}
    \caption{Quantitative comparison of safe flow expansion round counts versus collision rate, validity, minimum clearance, and time-to-goal. Safe flow expansion decreases trajectory-wise collision rate (25\%  to 0.1\%), increases action-wise validity (30\% to 85\%). (TODO: update with the latest result)}
    \label{fig:polytope}
\end{figure}
