...
\end{lemma}
Here $T^\star$ counts sequential queries and model updates in the analysis at fixed $(\o,\gamma)$. Alg.~\ref{alg:sfe} uses batched acquisition and updates across contexts, so its total verifier count is distinct from this analysis budget.
